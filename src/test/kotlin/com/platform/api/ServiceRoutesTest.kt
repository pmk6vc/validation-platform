...
class ServiceRoutesTest : DatabaseTestBase() {
    ...
    @Test
    fun `GET services should return empty list when no services`() = testApplication {
    ...
    @Test
    fun `GET services with organizationId filter should return filtered services`() = testApplication {
        application { configureTestApplication() }
    ...
    @Test
    fun `GET services with cluster filter should return filtered services`() = testApplication {
        application { configureTestApplication() }
    ...
    @Test
    fun `GET services with namespace filter should return filtered services`() = testApplication {
        application { configureTestApplication() }
    ...
    @Test
    fun `GET service by id should return 404 when not exists`() = testApplication {
        application { configureTestApplication() }
    ...
    @Test
    fun `GET service should include all fields in response`() = testApplication {
        application { configureTestApplication() }
