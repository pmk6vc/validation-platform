...
class OrganizationRoutesTest : DatabaseTestBase() {
    ...
    @Test
    fun `GET organizations should return empty list when no organizations`() = testApplication {
    ...
    @Test
    fun `GET organizations should return all organizations`() = testApplication {
        application { configureTestApplication() }
    ...
    @Test
    fun `GET organization by id should return organization when exists`() = testApplication {
        application { configureTestApplication() }
    ...
    @Test
    fun `GET organization by id should return 404 when not exists`() = testApplication {
        application { configureTestApplication() }
